 ...
 * Devolverá 0 si se transmitieron con eso, -1 en caso contrarioint transmitir_visiones(cuervo_tres_ojos_t* cuervo, cuervo_aprendiz_t* aprendiz, bool (*es_transmisible)(vision_t));
 */
